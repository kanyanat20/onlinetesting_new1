...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ดูผลสอบรายบุคคล</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <table class="table table-bordered table-striped">
            <thead>
                ...
                <th scope="col">ดูผลสอบรายบุคคล</th>
                </tr>
            </thead>
            <tbody>
    <?php 
    ...
    foreach ($rows as $key => $value) {
        // เพิ่มเงื่อนไขเพื่อตรวจสอบว่า urole เป็น "admin" หรือไม่
        if ($value['urole'] !== 'admin') {
    ?>
    <tr>
        ...
        <td>
            <a href="exam_result_user.php?id=<?php echo $value['user_id']; ?>" class="btn btn-success">ดู</a>
        </td>
    </tr>
    <?php
            $i++;
