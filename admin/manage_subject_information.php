        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">จัดการข้อมูลวิชา</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div>
              <form method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="subject_name" class="form-control mb-2" placeholder="ชื่อวิชา">
                <input type="file" name="subject_image" class="form-control mb-2" placeholder="รูปภาพ" accept="image/*">
        ...
        if(isset($_POST['submit'])){
          ...
          move_uploaded_file($_FILES["subject_image"]["tmp_name"], $target_file);

          include '../config/db.php';
          $sql = "INSERT INTO subject_information (subject_name, subject_image) VALUES (:subject_name, :subject_image)";
          $stmt = $conn->prepare($sql);
          $stmt->bindParam(':subject_name', $subject_name);
          $stmt->bindParam(':subject_image', $subject_image);
          $stmt->execute();
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <td>
                    <a href="edit_subject_information.php?id=<?php echo $value['subject_id']; ?>" class="btn btn-warning">แก้ไข</a>
                    <button type="button" onclick="delete_admin(<?php echo $value['subject_id']; ?>)" class="btn btn-danger">ลบ</button>
                </td>
                </tr>
                <?php
                $i++;
...
<script>
    const delete_admin = (id) => {
        if(confirm('คุณต้องการลบข้อมูลวิชาใช่หรือไม่')){
            window.location.href = 'delete_subject_information.php?id='+id;
        }
    }
</script>
<!-- jQuery -->
