  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- Main row -->
        <div>
        <h3 class="mb-4 text-center">New Admin</h3>
                ...
                <div class="form-group">
	              <input id="password" type="password" class="form-control" name="confirm-password" placeholder="Confirm Password" required>
	            </div>
	            <div class="form-group">
	            	<button type="submit" name="submit" class="form-control btn btn-primary submit px-3">New Admin</button>
	            </div>
	          </form>
...
if($result->rowCount() > 0){
    ...
    $sql = "INSERT INTO users (email, password, urole) VALUES ('$email', '$password', 'admin')";
    $result = $conn->query($sql);
